...
if __name__ == '__main__':
    ...
    DataModule = UETDataModule('data/uet', batch_size=4, num_workers=2, k_shots=5)
    DataModule.setup()
    dataloader_trn = DataModule.train_dataloader()
    dataloader_val = DataModule.test_dataloader()
